      ...
      <div className="footer-content">
        <div className="footer-content-column">
          <div className="footer-logo">
            <a className="footer-logo-link" href="https://www.adacodesolutions.com/">
              <span className="hidden-link-text">LOGO</span>
              <h2>ADACODE</h2>
            </a>
          </div>
          <div className="footer-menu">
            <h4>3rd Floor,4 Wings Building, <br />Panniyankara Kozhikode</h4>
          </div>
        </div>
        <div className="footer-content-column">
          <div className="footer-menu">
            <h2 className="footer-menu-name"> Our Services</h2>
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h2 className="footer-menu-name">Our Courses</h2>
            <ul id="menu-quick-links" className="footer-menu-list">
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="#">Web Developement</a>
              </li>
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="#">Robotics</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
              ...
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">Embedded Systems and IoT</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            ...
            <a className="footer-call-to-action-button button"  href="https://api.whatsapp.com/send?phone=9947276566 &text= Hi" target="_self"> Get in Touch </a>
          </div>
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title"> You Call Us</h2>
            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:8943927207" target="_self"> 9947276566 </a></p>
          </div>
        </div>
        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <a className="footer-social-link linkedin" href="https://www.instagram.com/adacodesolutions" target="_blank">
          ...
          <a className="footer-social-link youtube" href="https://www.youtube.com/@AdacodeSolutions" target="_blank">
          ...
          <a className="footer-social-link twitter" href="https://www.facebook.com/adacodesolutions" target="_blank">
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> ©2024 | adacodesolutions.com| All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
