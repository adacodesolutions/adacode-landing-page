      ...
      <div className="footer-content">
        <div className="footer-content-column">
          ...
          <div className="footer-menu">
            <h4>3rd Floor,4 Wings Building,Panniyankara Kozhikode</h4>
          </div>
        </div>
        <div className="footer-content-column">
          <div className="footer-menu">
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            ...
            <a className="footer-call-to-action-button button" href="whatsapp://send?text=Hi&phone=+918943927207" target="_self"> Get in Touch </a>
          </div>
          <div className="footer-call-to-action">
